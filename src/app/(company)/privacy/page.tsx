  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16">
      ...
      <div className="mt-12 space-y-8">
        ...
        <section className="rounded-2xl bg-white p-8 shadow-sm">
          ...
          <div className="mt-4 space-y-4 text-gray-600">
            ...
            <ul className="list-inside list-disc space-y-2">
              ...
              <li>
                <strong className="text-gray-900">Payment Information:</strong> Credit card numbers
                and other payment details (processed securely by our payment processors).
              </li>
              <li>
                <strong className="text-gray-900">Account Information:</strong> Username, password,
                and account preferences.
              </li>
              <li>
                <strong className="text-gray-900">Communication Data:</strong> Information you provide
                when contacting customer support or participating in surveys.
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="rounded-2xl bg-white p-8 shadow-sm">
          <h2 className="text-xl font-semibold text-gray-900">Automatically Collected Information</h2>
          <div className="mt-4 space-y-4 text-gray-600">
            <p>
        ...
        <section className="rounded-2xl bg-white p-8 shadow-sm">
          ...
          <div className="mt-4 space-y-4 text-gray-600">
            ...
            <ul className="list-inside list-disc space-y-2">
              <li>
                <strong className="text-gray-900">Service Providers:</strong> Companies that help us
                operate our business (shipping, payment processing, marketing).
              </li>
              <li>
                <strong className="text-gray-900">Business Partners:</strong> Trusted partners for
                joint offerings (with your consent).
              </li>
              <li>
        ...
        <section className="rounded-2xl bg-white p-8 shadow-sm">
          ...
          <div className="mt-4 space-y-4 text-gray-600">
            ...
            <p>
              To exercise these rights, please contact us at privacy@luminawatches.com.
            </p>
          </div>
        </section>
          ...
          <div className="mt-4 text-gray-600">
            ...
            <div className="mt-4 space-y-2">
              <p>
                ...
                <a href="mailto:privacy@luminawatches.com" className="text-black hover:underline">
                  privacy@luminawatches.com
                </a>
              </p>
              <p>
