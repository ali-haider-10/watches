...
import { getProfile, updateProfile, createCheckout } from "@/lib/api";
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <div className="rounded-2xl border border-gray-200 bg-white p-6">
                ...
                <p className="mt-4 text-sm text-gray-500">
                  Cash on Delivery only. Pay in cash when your order is delivered.
                </p>
                <div className="mt-4 inline-flex items-center gap-2 rounded-lg bg-gray-100 px-3 py-2">
                ...
                <p className="mt-3 text-xs text-gray-500">
                  Please keep the exact amount ready at delivery time.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-gray-200 bg-white p-6">
                ...
                <p className="mt-4 text-sm text-gray-500">
                  Your order will be placed immediately and you&apos;ll receive your order number right away.
                </p>
              </div>
            </div>
              ...
              <div className="rounded-2xl border border-gray-200 bg-white p-6">
                ...
                <div className="mt-6 space-y-3 border-t border-gray-200 pt-6">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium text-gray-900">{formatPrice(total, "PKR")}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-gray-500">{formatPrice(0, "PKR")}</span>
                  </div>
                </div>
                ...
                <div className="mt-6 border-t border-gray-200 pt-6">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-2xl font-bold text-gray-900">{formatPrice(total, "PKR")}</span>
                  </div>
                </div>
                ...
                >
                  {submitting ? (
                    <>
                      ...
                      {submitting ? "Processing..." : "Placing COD Order..."}
                    </>
                  ) : (
                    <>
